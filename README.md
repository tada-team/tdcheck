...
3. Установить на сервер мониторинг (требуется версия golang 1.16 или более поздняя):

```bash
go get -u github.com/tada-team/tdcheck
``` 
...
```json
{
  ...
  "panels": [
    ...
    },
    {
      ...
      "timeRegions": [],
      "timeShift": null,
      "title": "Ошибки ws-клиента при проверке доставки сообщений",
      "tooltip": {
        "shared": true,
        "sort": 0,
        "value_type": "individual"
    ...
    },
    {
      ...
      "timeRegions": [],
      "timeShift": null,
      "title": "Создание сообщения (крупно)",
      "tooltip": {
        "shared": true,
        "sort": 0,
        "value_type": "individual"
    ...
    },
    {
      ...
      "timeRegions": [],
      "timeShift": null,
      "title": "Доставка собеседнику (крупно)",
      "tooltip": {
        "shared": true,
        "sort": 0,
        "value_type": "individual"
